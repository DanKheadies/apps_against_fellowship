 ...
 * @param {T[]} array the array to "Cut" and reform
 * @param {number} cutVariance Optional. The variance of where the cut takes place towards the center of the deck
 * @return {T[]} the new cut deck. Note. This does not modify the original array
 */
export function cut<T>(array: T[], cutVariance = 10): T[] {
