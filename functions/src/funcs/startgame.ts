 ...
 * @param {Player[]} players the list of participating players in this game
 ...
 * @param {Game} game the id of the game
 * @param {Player[]} players the list of players participating in this game
 * @param {GameCardPool} cardPool the pool of cards to draw from
 * @return {Promise<Turn>}
 */
 ...
 * @see {@link shuffle}
 * @param {CardSet[]} cardSets the array of {@link CardSet} to process
 ...
 * @param {number} numPlayers the number of players that are in the game
 * @return {number}
 */
